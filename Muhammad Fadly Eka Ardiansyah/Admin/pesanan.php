        ...
        <table cellpadding="10" cellspacing="0" p>
            ...
            foreach($data as $row){
                ...
                <tr>
                    ...
                    <td><?= $row['status']; ?></td>
                    <td>
                        <a href="verif.php?id_transaksi=<?= $row['id_transaksi']; ?>"><i class="fa-solid fa-check"></i></a>
                        <a href="tolak.php?id_transaksi=<?= $row['id_transaksi']; ?>"><i class="fa-solid fa-xmark"></i></a>
                    </td>
                </tr>
                <?php
            }
